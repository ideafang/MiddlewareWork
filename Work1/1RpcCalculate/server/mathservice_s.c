...
extern const MIDL_SERVER_INFO MathService_ServerInfo;

extern const RPC_DISPATCH_TABLE MathService_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE MathService___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x91B13F11,0xF2BF,0x4744,{0x9B,0x1C,0xEF,0x6A,0x6B,0x9C,0x42,0xDD}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&MathService_v1_0_DispatchTable,
    0,
    0,
    0,
    &MathService_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE MathService_v1_0_s_ifspec = (RPC_IF_HANDLE)& MathService___RpcServerInterface;
...
static const MIDL_STUB_DESC MathService_StubDesc = 
    {
    (void *)& MathService___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION MathService_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE MathService_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)MathService_table
    };

static const SERVER_ROUTINE MathService_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)math,
    (SERVER_ROUTINE)ShutDown
    };

static const MIDL_SERVER_INFO MathService_ServerInfo = 
    {
    &MathService_StubDesc,
    MathService_ServerRoutineTable,
    mathservice__MIDL_ProcFormatString.Format,
    MathService_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
